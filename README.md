...
- (Geocodio)[https://geocod.io] - Awesome geocoding service with a very generous free tier. 2,500 free lookups every day, which is way more than enough for every day usage. They also have permit storing of geocoding results (unlike a certain other big map provider)
- (Mapbox)
